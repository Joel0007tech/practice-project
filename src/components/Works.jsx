...
const Works = () => {
  ...
  <h3 className='text-center text-white font-bold text-2xl sm:text-center'>Our Works</h3>
...
<img src={firstImage} alt="mask group" className='w-[450px] h-[300px] sm:m-auto sm:h-[200px] sm:w-[350px]'/>
<div className='flex flex-col gap-6 sm:flex sm:flex-col'>
  <h3 className='text-white font-bold text-2xl sm:text-center sm:text-white sm:font-bold sm:text-xl'>Bulldog <br className='sm:hidden'/>Billionaires</h3>
...
Bulldog Billionaires is a collection of<br/>
 2,000 randomly generated NFTs that<br/>
  ...
  <a href="" className="text-center bg-purple-700 py-3 px-9 sm:py-3 sm:px-9 text-white 
  font-normal w-[180px] m-auto sm:m-auto rounded-lg relative
   right-10 bottom-10 sm:relative sm:right-0 sm:top-2 ">Visit Website</a>
</div>
    </div>
  ...
  <h3 className='text-white font-bold text-2xl sm:text-white sm:font-bold sm:text-center'>T-connect</h3>
  <p className='text-white font-normal'>T-connect is an NFT Marketplace<br/> platform where users can lend and<br/> rent NFTs.
</p>
<a href="" className="text-center bg-purple-700 py-3 px-9 text-white font-normal
 w-[180px] h-[50px] m-auto rounded-lg relative right-10 bottom-10">Visit Website</a>
</div>
